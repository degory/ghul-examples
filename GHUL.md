...
* **Type Inference:**
  ...
  * It infers anonymous function return types from their body, and infers anonymous function parameter types from the expected function type if known. Inferred types are always concrete; the compiler does not generalize an anonymous function to a polymorphic type.
  * It **does not infer** types for named-function or method parameters or return types - those are always written out.
